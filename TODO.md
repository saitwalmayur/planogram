...
- [x] Add snapping mechanism to cupboard when it is near a door corner.
- [x] Add bottle item to library with automatic shelf alignment.
- [x] Show view cube at right top corner to control scene.
